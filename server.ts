...
const DEFAULT_SYSTEM_OWNER_MASTER_KEY = 'SCHOOL-SYSTEM-OWNER-2026';
...
async function startServer() {
  ...
  app.listen(PORT, HOST, () => {
    console.log(`====================================================`);
    console.log(`  Primary School ERP School ERP Web Service    `);
