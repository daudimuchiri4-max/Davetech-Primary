...
export const SystemOwnerConsole: React.FC<{ onNavigate?: (view: any) => void }> = ({ onNavigate }) => {
  ...
  const handleRestoreDefaultKey = async () => {
    ...
    try {
      const res = await subscriptionService.restoreDefaultMasterPasskey(school?.id || 'SCHOOLM');
  ...
  const handleSavePayoutConfig = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await subscriptionService.saveSubscriptionConfig(school?.id || 'SCHOOLM', updated);
  ...
  const handleApplyRestartDates = async (e: React.FormEvent) => {
    ...
    try {
      const updated = await subscriptionService.restartSubscriptionDates(school?.id || 'SCHOOLM', {
  ...
  const handleConfirmSuspend = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast('Primary School ERP subscription has been suspended.', 'warning');
    } catch (err: any) {
  ...
  const handleResumeSubscription = async () => {
    ...
    try {
      const updated = await subscriptionService.resumeSubscription(school?.id || 'SCHOOLM');
      setSubscription(updated);
      showToast('Primary School ERP subscription resumed and active!', 'success');
    } catch (err: any) {
  ...
  const handleToggleLock = async () => {
    ...
    if (!window.confirm(`Are you sure you want to ${actionName} Primary School ERP's ERP access?`)) {
      return;
    }
    ...
    try {
      ...
      showToast(
        isCurrentlyLocked
          ? 'Primary School ERP has been reactivated and unlocked.'
          : 'Primary School ERP ERP has been locked.',
  ...
  const handleExtendDays = async (days: number) => {
    try {
      const updated = await subscriptionService.grantGraceExtension(school?.id || 'SCHOOLM', days);
      setSubscription(updated);
      showToast(`Granted +${days} days extension to Primary School ERP.`, 'success');
    } catch (e: any) {
      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 text-white shadow-2xl space-y-6">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            This management console is strictly restricted to the software owner and provider. Primary School ERP school staff do not have access to this area.
          </p>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setPasskeyInput('SCHOOL-SYSTEM-OWNER-2026');
                    setAuthError('');
                  }}
              ...
              <input
                ...
                placeholder="e.g. SCHOOL-SYSTEM-OWNER-2026"
          ...
          <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-800/80 text-[11px] text-slate-400 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <span>Default key: <code className="text-indigo-300 font-mono">SCHOOL-SYSTEM-OWNER-2026</code></span>
            </div>
            <button
              type="button"
        ...
        >
          <div className="space-y-4 text-xs">
            <div className="p-3 bg-amber-50 border border-amber-200 text-amber-900 rounded-xl flex items-start gap-2.5">
              ...
              <div>
                <span className="font-bold">Restore Master Key:</span> This operation will immediately reset the System Owner Master Passkey to the standard platform default (<code className="font-mono font-bold">SCHOOL-SYSTEM-OWNER-2026</code>).
              </div>
            </div>
            ...
            <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
              ...
              <p className="font-mono font-bold text-slate-800 text-sm">SCHOOL-SYSTEM-OWNER-2026</p>
            </div>
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Software Ownership, License Management & Billing Engine for Primary School ERP
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Primary KPI Grid for Primary School ERP */}
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-2">
          ...
          <p className="text-[11px] text-slate-500">
            {health.isSuspended
              ...
              : health.isLocked
              ? 'Primary School ERP is currently locked'
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs space-y-4">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 bg-slate-50 rounded-xl space-y-1">
              ...
              <p className="font-bold text-slate-900">{school?.name || 'Primary School ERP'}</p>
            ...
            <div className="p-3 bg-slate-50 rounded-xl space-y-1">
              ...
              <p className="font-bold text-slate-800">{school?.email || 'admin@example-school.ac.ke'}</p>
      ...
      >
        <form onSubmit={handleRecordManualPayment} className="space-y-4 text-xs">
          <p className="text-slate-500">
            Record a confirmed M-Pesa transaction or bank transfer received from Primary School ERP.
          </p>
        ...
        <form onSubmit={handleChangeMasterPasskey} className="space-y-4 text-xs">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Enter current passkey (e.g. SCHOOL-SYSTEM-OWNER-2026)"
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
            ...
            >
              ...
              <span>Restore Default (`SCHOOL-SYSTEM-OWNER-2026`)</span>
            </button>
            <div className="flex items-center gap-2">
              <Button
                type="button"
          ...
          <div className="space-y-4 text-xs">
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
              ...
              <div className="space-y-1 text-slate-700">
                <p><strong>Billed To:</strong> {school?.name || 'Primary School ERP'}</p>
      ...
      >
        <form onSubmit={handleApplyRestartDates} className="space-y-4 text-xs">
          <div className="p-3 bg-indigo-50 border border-indigo-200 text-indigo-950 rounded-2xl flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold">System Owner Date Adjustment:</span> Set custom active dates for Primary School ERP. Restarting the dates allows you to roll over cycles, align with academic terms, or grant fresh subscription periods.
            </div>
          </div>
      ...
      >
        <form onSubmit={handleConfirmSuspend} className="space-y-4 text-xs">
          <div className="p-3.5 bg-amber-50 border border-amber-200 text-amber-900 rounded-2xl flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold">Subscription Suspension:</span> Suspending Primary School ERP will immediately lock user access and display an official suspension notice. You can resume the subscription at any time without data loss.
            </div>
          </div>
