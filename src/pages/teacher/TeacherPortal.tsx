  ...
  const playWelcomeSound = (studentName: string) => {
    ...
    try {
      if ('speechSynthesis' in window) {
        ...
        const utterance = new SpeechSynthesisUtterance(`Welcome to Primary School ERP, ${firstName}`);
        utterance.rate = 1.0;
        utterance.pitch = 1.1;
        utterance.onerror = () => {};
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="e.g. catherine.mutua or cmutua@example-school.ac.ke"
                  required
  ...
  const testAudio = () => {
    try {
      ...
      if ('speechSynthesis' in window) {
        ...
        const utter = new SpeechSynthesisUtterance('Audio and microphone check successful. Primary School ERP.');
        utter.rate = 1.0;
