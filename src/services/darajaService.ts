...
export interface StkPushRequest {
  ...
  amount: number;
  accountReference: string; // e.g. SCHOOLM/2026/001 or Student Name
...
export const DEFAULT_DARAJA_CONFIG: DarajaConfig = {
  environment: 'sandbox',
  consumerKey: 'SCHOOLM_Daraja_Key_Test2026',
  consumerSecret: 'SCHOOLM_Daraja_Secret_Test2026',
  passkey: 'bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919',
  shortcode: '174379',
  initiatorName: 'testapi',
  callbackUrl: 'https://example-school.ac.ke/api/mpesa/callback',
};
    ...
    try {
      const serverRes = await fetch('/api/mpesa/stkpush', {
        ...
        body: JSON.stringify({
          ...
          amount: req.amount,
          accountReference: req.accountReference || 'SCHOOLM-FEES',
