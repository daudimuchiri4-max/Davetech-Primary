...
export const DEFAULT_SYSTEM_OWNER_MASTER_KEY = 'SCHOOL-SYSTEM-OWNER-2026';
...
export const DEFAULT_SUBSCRIPTION_CONFIG: SchoolSubscriptionConfig = {
  ...
  licenseKey: 'LIC-2026-SCHOOLM-M08-88F9A',
...
export const subscriptionService = {
  ...
  /**
   * Restore the Master Passkey to the system default ('SCHOOL-SYSTEM-OWNER-2026')
   */
   ...
   */
  generateLicenseKey(schoolId: string = 'SCHOOLM'): string {
